  ...
  runWithSnapshot_(snapshot) {
    ...
    if (!lockAcquired) {
      throw this.createError_(
        TOS_ERROR_CODE.PIPELINE_ALREADY_RUNNING,
    ...
    this.safeAudit_({
      ...
      status: TOS_PIPELINE_STATUS.STARTED,
      message:
    ...
    try {
      ...
      if (
        ...
        throw this.createError_(
          TOS_ERROR_CODE.SNAPSHOT_UNSAFE,
      ...
      this.safeAudit_({
        ...
        runId: runId,
        module: this.MODULES.PIPELINE,
        status: TOS_PIPELINE_STATUS.SUCCESS,
        message:
      ...
      this.safeAudit_({
        ...
        runId: runId,
        module: this.MODULES.PIPELINE,
        status: TOS_PIPELINE_STATUS.FAILED,
        message:
          'FailedModule=' +
          currentModule +
          ', Error=' +
  ...
  logSkippedModules_(
    ...
    for (
      ...
      this.safeAudit_({
        ...
        runId: runId,
        module: moduleName,
        status: TOS_PIPELINE_STATUS.SKIPPED,
        message:
